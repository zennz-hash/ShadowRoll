 ...
 * @beta
 */
async function deploy({ config = {}, artifactResolver, provider, executionEventListener, deploymentDir, ignitionModule, deploymentParameters, accounts, defaultSender: givenDefaultSender, strategy, strategyConfig, maxFeePerGasLimit, maxFeePerGas, maxPriorityFeePerGas, gasPrice, disableFeeBumping, maxRetries, retryInterval, }) {
    ...
    const resolvedConfig = {
        ...
        maxRetries: maxRetries ?? defaultConfig_1.defaultConfig.maxRetries,
        retryInterval: retryInterval ?? defaultConfig_1.defaultConfig.retryInterval,
        ...config,
    };
