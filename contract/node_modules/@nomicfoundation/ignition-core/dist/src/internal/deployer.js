...
class Deployer {
    ...
    async deploy(ignitionModule, deploymentParameters, accounts, defaultSender) {
        ...
        if (this._hasBatchesToExecute(batches)) {
            ...
            const executionEngine = new execution_engine_1.ExecutionEngine(this._deploymentLoader, this._artifactResolver, this._executionStrategy, this._jsonRpcClient, this._executionEventListener, this._config.requiredConfirmations, this._config.timeBeforeBumpingFees, this._config.maxFeeBumps, this._config.blockPollingInterval, this._config.disableFeeBumping, this._config.maxRetries, this._config.retryInterval);
